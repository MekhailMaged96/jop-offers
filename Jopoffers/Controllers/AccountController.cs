...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult EditProfileAccount()
        {
            ...
            EditProfileAccount account = new EditProfileAccount();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditProfileAccount(EditProfileAccount account)
        {
            var UserId = User.Identity.GetUserId();
            var user = db.Users.Where(a => a.Id == UserId).SingleOrDefault();
            ...
            {
                var newpassword = UserManager.PasswordHasher.HashPassword(account.NewPassword);
